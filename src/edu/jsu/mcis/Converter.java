    ...
    public static String csvToJson(String csvString) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                int result = Integer.parseInt(rows[1]);
                int result2 = Integer.parseInt(rows[2]);
                int result3 = Integer.parseInt(rows[3]);
                int result4 = Integer.parseInt(rows[4]);
                mainData.add("[" + result + "," + result2 + "," + result3 + "," + result4 + "]");
